...
document.addEventListener("DOMContentLoaded", () => {
    ...
    //init Log
    const initLog = document.querySelector('.log-title');
    const initString = document.createTextNode('Log Message');

    initLog.appendChild(initString);
...
window.console = {
    log: function(str){
        const logWindow = document.querySelector('.log .log-content');
